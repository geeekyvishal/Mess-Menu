document.addEventListener("DOMContentLoaded", function () {
    const menuData = {
        Sunday: {
            ...
            dinner: {
                name: "Kadhai Paneer, Dal Fry, Rice, Ice cream",
        ...
        Monday: {
            ...
            lunch: {
                name: "Soya Wadi,Dal Tadka,Chapati,Rice",
                daily:"Salad, Achar, Papad",
            ...
            snacks: {
                name: "Sweet Corn/Mutter Masala, Coffee ☕",
                image: "https://www.lordbyronskitchen.com/wp-content/uploads/2018/02/3-4.jpg",
                servings: "Snacks",
                time: "5:30 To 6:30 PM",
            },
            dinner: {
                name: "Lauki-Chana/Masala Bhindi, Dal Makhani",
                daily:"Salad Achar Chapati Jeera Rice",
        ...
        Tuesday: {
            ...
            dinner: {
                name: "Matar Aloo, Chana Dal, Jalebi/Fruit Custard",
        ...
        Wednesday: {
            breakfast: {
                name: "Uttapam, Sambhar, Chutney, Seasonal fruit",
                daily:"Bread, Butter, Jam, Milk, Tea ☕",
            ...
            lunch: {
                name: "Kadi Pakoda, Sem Aloo, Chapati,Veg Pulav",
                daily:"Salad, Achar, Papad",
            ...
            snacks: {
                name: "Maggie/Sandwich, Tea ☕",
                image: "https://i.ytimg.com/vi/CthdvfRdABs/maxresdefault.jpg",
                servings: "Snacks",
                time: "5:30 To 6:30 PM",
            },
            dinner: {
                name: "Paneer/Seasonal veg, Mixed Veg",
                daily:"Salad Achar Chapati, Rice",
        ...
        Thursday: {
            ...
            lunch: {
                name: "Desi Chana Gravy, Masoor Dal, Rice, Chapati,Boondi Raita",
                daily:"Salad, Achar, Papad",
        ...
        Friday: {
            breakfast: {
                name: "Wada Sambhar Chutney, Banana",
                daily:"Bread, Butter, Jam, Milk, Tea ☕",
            ...
            dinner: {
                name: "Paneer Variety, Dal Makhani",
                daily:"Salad Achar Chapati, Rice",
                image: "https://media.cntraveller.in/wp-content/uploads/2020/05/homemade-paneer-recipes-1366x768.jpg",
                servings: "Dinner",
                time: "7:30 To 9:30 PM",
        ...
        Saturday: {
            ...
            dinner: {
                name: "Seasonal Veg/Corn Palak, Chana Dal",
                daily:"Salad Achar Chapati,Rice",
